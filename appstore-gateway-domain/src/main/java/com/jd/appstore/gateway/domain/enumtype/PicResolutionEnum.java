package com.jd.appstore.gateway.domain.enumtype;
...
public enum PicResolutionEnum {
    ...
    COVER("COVER","cover/"),
    IMGPIC("IMGPIC","img_pic/"),
    RECIMAGE("RECIMAGE","recImage/"),
    CATEGORYIMAGE("CATEGORYIMAGE","categoryImage/"),
    TOPICIMAGE("TOPICIMAGE","topicImage/"),
    ANDROIDCLIENT("ANDROIDCLIENT","androidClient/"),
    ACTIVITY("ACTIVITY","activity/"),
    COVER_NO("NO","appstore/"),
    COVER_N1("N1","appstore/"),
    COVER_N2("N2","appstore/"),
    COVER_N3("N3","appstore/"),
    COVER_N4("N4","appstore/"),
    COVER_N5("N5","appstore/"),
